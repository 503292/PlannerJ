...
describe('ProjectHistory e2e test', () => {
    ...
    it('should load JobHistories', async () => {
        ...
        expect(await jobHistoryComponentsPage.getTitle()).to.eq('plannerApp.jobHistory.home.title');
    });

    it('should load create ProjectHistory page', async () => {
        await jobHistoryComponentsPage.clickOnCreateButton();
        jobHistoryUpdatePage = new JobHistoryUpdatePage();
        expect(await jobHistoryUpdatePage.getPageTitle()).to.eq('plannerApp.jobHistory.home.createOrEditLabel');
    ...
    it('should delete last ProjectHistory', async () => {
        ...
        expect(await jobHistoryDeleteDialog.getDialogTitle()).to.eq('plannerApp.jobHistory.delete.question');
